...
fn props() -> Properties {
    ...
    properties.insert("tokenDecimals".to_string(), NATIVE_DECIMALS.into());
    properties.insert("tokenSymbol".to_string(), "REV".into());
    properties
}
...
fn testnet_genesis() -> Value {
    ...
    json!({
      ...
      "contractsEvm": ContractsEvmConfig {
        endowed_accounts: vec![
          (hex!("75e480db528101a381ce68544611c169ad7eb342").into(), endowment)],
      },
